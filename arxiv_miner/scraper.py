...
class Record(object):
    ...
    def __init__(self, xml_record):
        ...
        self.journal_reference = self._get_text(ARXIV,'journal_reference')
    ...
    def _get_authors(self):
        ...
        last_names = [author.find(ARXIV + 'keyname').text for author in authors_xml]
        first_names = ['' if author.find(ARXIV + 'forenames') is None else author.find(ARXIV + 'forenames').text for author in authors_xml]
    ...
    def _get_affiliation(self):
        ...
        try:
            affiliation = [author.find(ARXIV + 'affiliation').text for author in authors]
            return affiliation
        except:
            return []
